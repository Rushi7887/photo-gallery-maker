...
import viz02 from "@/assets/3d/v2/viz-02.webp.asset.json";
import viz03 from "@/assets/3d/v2/viz-03.webp.asset.json";
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      { src: farmhouseParbhani01.url, caption: "Farmhouse, Parbhani" },
      { src: farmhouseParbhani02.url, caption: "Farmhouse, Parbhani" },
      { src: farmhouseParbhani02.url, caption: "Farmhouse, Parbhani" },
      { src: farmhousePaithan04.url, caption: "Farmhouse, Paithan" },
      { src: farmhousePaithan04.url, caption: "Farmhouse, Paithan" },
      { src: farmhousePaithan06.url, caption: "Farmhouse, Paithan" },
      { src: farmhouseParbhani01.url, caption: "Apartment, Chhatrapati Sambhajinagar" },
      { src: farmhousePaithan06.url, caption: "Apartment, Chhatrapati Sambhajinagar" },
      { src: bungalowSamba10.url, caption: "Bungalow, Chhatrapati Sambhajinagar" },
      { src: bungalowSamba10.url, caption: "Bungalow, Chhatrapati Sambhajinagar" },
